...
<p>Теперь вам нужно <a href='<?= URL::to('help/binding') ?>'>ввести логин и пароль от сайта СП</a> и <a href='<?= URL::to('help/gift') ?>'>получить пробный период</a>, после чего вы сможете использовать все возможности сервиса.</p>
